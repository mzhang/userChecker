...
Anyway, the goal is for the .py file to read the .csv files and to see if each username exists on each website. So you can hopefully choose a username in a few minutes instead of the weeks it took me. 
